...
<?php } ?>
<?php if(!empty($qode_options_proya['quote_link_blockqoute_fontsize']) || !empty($qode_options_proya['quote_link_blockqoute_lineheight']) || (isset($qode_options_proya['quote_link_blockqoute_letterspacing']) && $qode_options_proya['quote_link_blockqoute_letterspacing'] !== "") || (isset($qode_options_proya['quote_link_blockqoute_texttransform']) && $qode_options_proya['quote_link_blockqoute_texttransform'] !== "")){ ?>
	.blog_holder article.format-quote .post_text .post_title p,
	.blog_holder article.format-link .post_text .post_title p,
	.blog_holder article.format-quote .post_text .quote_author,
	blockquote h5
...
<?php if(isset($qode_options_proya['blog_masonry_title_hover_color']) && $qode_options_proya['blog_masonry_title_hover_color'] !== '') { ?>
	.blog_holder.masonry h5 a:hover
	{
...
<?php if (!empty($qode_options_proya['vertical_menu_color']) || !empty($qode_options_proya['vertical_menu_fontsize']) || !empty($qode_options_proya['vertical_menu_fontstyle']) || !empty($qode_options_proya['vertical_menu_lineheight']) || !empty($qode_options_proya['vertical_menu_fontweight']) ||
	...
	<?php if (!empty($qode_options_proya['vertical_menu_letterspacing'])) { ?> letter-spacing: <?php echo $qode_options_proya['vertical_menu_letterspacing'];  ?>px; <?php } ?>
...
if(isset($qode_options_proya['portfolio_list_standard_category_color']) && $qode_options_proya['portfolio_list_standard_category_color'] !== '-1') {
...
<?php if(isset($qode_options_proya['paspartu']) && $qode_options_proya['paspartu'] == 'yes') { ?>
	...
	.paspartu_outer{
		padding: 0 <?php echo $qode_options_proya['paspartu_width']; ?>% <?php echo $qode_options_proya['paspartu_width']; ?>% <?php echo $qode_options_proya['paspartu_width']; ?>%;
	}

	.paspartu_outer .content:not(.has_slider) .content_inner{
		padding-top: <?php echo $qode_options_proya['paspartu_width']; ?>%;
	}
...
if(!empty($qode_options_proya['woo_cart_title_size'])) { ?>
    ...
    .woocommerce-page .div.cart-collaterals h2 a {
        font-size: <?php echo $qode_options_proya['woo_cart_title_size']; ?>px;
    }
<?php } ?>
