    ...
    function qode_carousel( $atts, $content = null ) {
        ...
        if ($carousel != "") {
            ...
            if ( have_posts() ) : $postCount = 1; while ( have_posts() ) : the_post();
                ...
                if($image != ""){
                    $html .= "<span class='first_image_holder ".$has_hover_image."'>".wp_get_attachment_image($first_image, 'full')."</span>";
                }

                $second_image = qode_get_attachment_id_from_url($hover_image);

                if($hover_image != ""){
                    $html .= "<span class='second_image_holder ".$has_hover_image."'>".wp_get_attachment_image($second_image, 'full')."</span>";
                }
...
if (!function_exists('qode_google_map')) {
	...
	function qode_google_map($atts, $content = null) {
		...
		$html .= "<div class='google_map_shortcode_holder' style='height:" . $map_height . "px;'><div class='qode_google_map' id='" . $holder_id . "' " . $data_attribute . "></div>";
