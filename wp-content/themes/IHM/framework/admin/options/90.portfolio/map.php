...
$portfolioPage->addChild("panel2",$panel2);
	...
	$portfolio_list_standard_title_texttransform = new QodeField("selectblanksimple","portfolio_list_standard_title_texttransform","","Text Transform","This is some description",$options_texttransform);
	...
	$portfolio_list_standard_title_fontstyle = new QodeField("selectblanksimple","portfolio_list_standard_title_fontstyle","","Font Style","This is some description",$options_fontstyle);
	$row2->addChild("portfolio_list_standard_title_fontstyle",$portfolio_list_standard_title_fontstyle);
	$portfolio_list_standard_title_fontweight = new QodeField("selectblanksimple","portfolio_list_standard_title_fontweight","","Font Weight","This is some description",$options_fontweight);
	...
	$portfolio_list_standard_category_texttransform = new QodeField("selectblanksimple","portfolio_list_standard_category_texttransform","","Text Transform","This is some description",$options_texttransform);
	...
	$portfolio_list_standard_category_fontstyle = new QodeField("selectblanksimple","portfolio_list_standard_category_fontstyle","","Font Style","This is some description",$options_fontstyle);
	$row2->addChild("portfolio_list_standard_category_fontstyle",$portfolio_list_standard_category_fontstyle);
	$portfolio_list_standard_category_fontweight = new QodeField("selectblanksimple","portfolio_list_standard_category_fontweight","","Font Weight","This is some description",$options_fontweight);
	...
	$group4 = new QodeGroup("Title Style (Hover Text and Masonry Without Space)","Define styles for title");
	...
	$portfolio_list_gallery_title_texttransform = new QodeField("selectblanksimple","portfolio_list_gallery_title_texttransform","","Text Transform","This is some description",$options_texttransform);
	...
	$portfolio_list_gallery_title_fontstyle = new QodeField("selectblanksimple","portfolio_list_gallery_title_fontstyle","","Font Style","This is some description",$options_fontstyle);
	$row2->addChild("portfolio_list_gallery_title_fontstyle",$portfolio_list_gallery_title_fontstyle);
	$portfolio_list_gallery_title_fontweight = new QodeField("selectblanksimple","portfolio_list_gallery_title_fontweight","","Font Weight","This is some description",$options_fontweight);
	...
	$group5 = new QodeGroup("Category Style (Hover Text and Masonry Without Space)","Define styles for category");
	...
	$portfolio_list_gallery_category_texttransform = new QodeField("selectblanksimple","portfolio_list_gallery_category_texttransform","","Text Transform","This is some description",$options_texttransform);
	...
	$portfolio_list_gallery_category_fontstyle = new QodeField("selectblanksimple","portfolio_list_gallery_category_fontstyle","","Font Style","This is some description",$options_fontstyle);
	$row2->addChild("portfolio_list_gallery_category_fontstyle",$portfolio_list_gallery_category_fontstyle);
	$portfolio_list_gallery_category_fontweight = new QodeField("selectblanksimple","portfolio_list_gallery_category_fontweight","","Font Weight","This is some description",$options_fontweight);
