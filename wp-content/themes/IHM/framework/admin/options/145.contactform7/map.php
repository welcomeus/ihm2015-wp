...
$qodeFramework->qodeOptions->addAdminPage("Contact Form 7",$contactform7page);
...
$contactform7page->addChild("panel1",$panel1);
	...
	$group4 = new QodeGroup("Form Elements' Padding","Define padding for form elements (text input fields, textarea, select)");
	...
	$group5 = new QodeGroup("Form Elements' Margin","Define margin for form elements (text input fields, textarea, select)");
	...
	$group6 = new QodeGroup("Button Background","Define background style for button");
	...
	$group7 = new QodeGroup("Button Border","Define border style for button");
	...
	$group8 = new QodeGroup("Button Text Style","Define text style for button");
...
$contactform7page->addChild("panel2",$panel2);
	...
	$group3 = new QodeGroup("Form Elements' Text Style","Define text style for form elements (text input fields, textarea, select)");
		...
		$group3->addChild("row2",$row2);
			...
			$cf7_custom_style_2_element_font_style = new QodeField("selectblanksimple","cf7_custom_style_2_element_font_style","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("cf7_custom_style_2_element_font_style",$cf7_custom_style_2_element_font_style);
			$cf7_custom_style_2_element_font_weight = new QodeField("selectblanksimple","cf7_custom_style_2_element_font_weight","","Font Weight","This is some description",$options_fontweight);
			$row2->addChild("cf7_custom_style_2_element_font_weight",$cf7_custom_style_2_element_font_weight);
			$cf7_custom_style_2_element_text_transform = new QodeField("selectblanksimple","cf7_custom_style_2_element_text_transform","","Text Transform","This is some description",$options_texttransform);
	...
	$group8 = new QodeGroup("Button Text Style","Define text style for button");
		...
		$row2 = new QodeRow(true);
		$group8->addChild("row2",$row2);
			$cf7_custom_style_2_button_font_style = new QodeField("selectblanksimple","cf7_custom_style_2_button_font_style","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("cf7_custom_style_2_button_font_style",$cf7_custom_style_2_button_font_style);
			$cf7_custom_style_2_button_font_weight = new QodeField("selectblanksimple","cf7_custom_style_2_button_font_weight","","Font Weight","This is some description",$options_fontweight);
			$row2->addChild("cf7_custom_style_2_button_font_weight",$cf7_custom_style_2_button_font_weight);
			$cf7_custom_style_2_button_text_transform = new QodeField("selectblanksimple","cf7_custom_style_2_button_text_transform","","Text Transform","This is some description",$options_texttransform);
...
$contactform7page->addChild("panel3",$panel3);
	...
	$group3 = new QodeGroup("Form Elements' Text Style","Define text style for form elements (text input fields, textarea, select)");
		...
		$group3->addChild("row2",$row2);
			...
			$cf7_custom_style_3_element_font_style = new QodeField("selectblanksimple","cf7_custom_style_3_element_font_style","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("cf7_custom_style_3_element_font_style",$cf7_custom_style_3_element_font_style);
			$cf7_custom_style_3_element_font_weight = new QodeField("selectblanksimple","cf7_custom_style_3_element_font_weight","","Font Weight","This is some description",$options_fontweight);
			$row2->addChild("cf7_custom_style_3_element_font_weight",$cf7_custom_style_3_element_font_weight);
			$cf7_custom_style_3_element_text_transform = new QodeField("selectblanksimple","cf7_custom_style_3_element_text_transform","","Text Transform","This is some description",$options_texttransform);
		...
		$group3->addChild("row3",$row3);
			...
			$row2->addChild("cf7_custom_style_3_element_letter_spacing",$cf7_custom_style_3_element_letter_spacing);
	$group4 = new QodeGroup("Form Elements' Padding","Define padding for form elements (text input fields, textarea, select)");
	...
	$group8 = new QodeGroup("Button Text Style","Define text style for button");
		...
		$row2 = new QodeRow(true);
		$group8->addChild("row2",$row2);
			$cf7_custom_style_3_button_font_style = new QodeField("selectblanksimple","cf7_custom_style_3_button_font_style","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("cf7_custom_style_3_button_font_style",$cf7_custom_style_3_button_font_style);
			$cf7_custom_style_3_button_font_weight = new QodeField("selectblanksimple","cf7_custom_style_3_button_font_weight","","Font Weight","This is some description",$options_fontweight);
			$row2->addChild("cf7_custom_style_3_button_font_weight",$cf7_custom_style_3_button_font_weight);
			$cf7_custom_style_3_button_text_transform = new QodeField("selectblanksimple","cf7_custom_style_3_button_text_transform","","Text Transform","This is some description",$options_texttransform);
