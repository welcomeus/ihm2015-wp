...
$qodeGeneral = new QodeMetaBox("page", "Qode General");
...
$qodeLeftMenuArea = new QodeMetaBox("page", "Qode Left Menu Area","vertical_area",array("no"));
...
$qodeHeader = new QodeMetaBox("page", "Qode Header","vertical_area",array("yes"));
...
$qodeTitle = new QodeMetaBox("page", "Qode Title");
...
$qodeContentBottom = new QodeMetaBox("page", "Qode Content Bottom");
...
$qodeBlog = new QodeMetaBox("page", "Qode Blog");
...
$qodeSideBar = new QodeMetaBox("page", "Qode Sidebar");
