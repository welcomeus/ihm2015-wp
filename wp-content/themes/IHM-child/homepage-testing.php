				...
				<div id="IHM_Stories_Home">
					...
					<div id="IHM_Stories" class="flexslider">
						...
						<a href="#first_section_homepage" class="slide_anchor_button anchor">
							...
							<img class="slide_to_arrow" src="http://welcomeus.wpengine.com/wp-content/uploads/2015/05/Assets-19.png" />
					...
					<div class="vc_row">
						...
						<div class="vc_col-sm-3">
							<div class="newsletter_cta_block">
					           	<a href="http://welcomeus.wpengine.com/IHM/sign-up/" class="IHM_popup">
					           		<div class="cta_block_image">
					           			<img src="http://welcomeus.wpengine.com/wp-content/uploads/2015/04/newsletter_block.png" />
					           		</div>
						...
						<div class="vc_col-sm-3">
							<div class="follow_cta_block">
				           		<div class="cta_block_image">
				           			<img src="http://welcomeus.wpengine.com/wp-content/uploads/2015/04/follow_us_block.png" />
				           		</div>
				           		<div class="cta_block_text">
					           		<p>Follow Us</p>
					           		<ul class="social_holder">
					           			<li>
					           				<a href="https://www.facebook.com/welcomeus" target="_blank"><img src="http://welcomeus.wpengine.com/wp-content/uploads/2015/05/IHM_Assets_large-02.png" /></a>
					           			</li>
					           			<li>
					           				<a href="https://instagram.com/welcome_us/" target="_blank"><img src="http://welcomeus.wpengine.com/wp-content/uploads/2015/05/IHM_Assets_large-03.png" /></a>
					           			</li>
					           			<li>
					           				<a href="https://twitter.com/welcome_us" target="_blank"><img src="http://welcomeus.wpengine.com/wp-content/uploads/2015/05/IHM_Assets_large-04.png" /></a>
					           			</li>
					           			<li>
					           				<a href="https://www.youtube.com/user/WelcomeIHM" target="_blank"><img src="http://welcomeus.wpengine.com/wp-content/uploads/2015/05/IHM_Assets_large-05.png" /></a>
					           			</li>
					           		</ul>
					           	</div>
							</div>
				...
				<div class="container_inner">
					...
					<div class="vc_row">
						...
						<div class="vc_col-sm-12 center">
							...
							<a href="http://welcomeus.wpengine.com/stories/" class="homepage_read_more">Read More</a>
					...
					<div class="homepage_events_feed">
						...
						<div class="vc_row">
							...
							<div class="vc_col-sm-12 center">
								...
								<a href="http://welcomeus.wpengine.com/events/" class="homepage_read_more">View All Events</a>
