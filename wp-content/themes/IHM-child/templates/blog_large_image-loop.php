				...
				<div class="post_text">
					<div class="post_text_inner">
						<div class="single_post_header">
							...
							<span class="single_social_share_desktop"><?php echo do_shortcode('[social_share_list]'); ?></span>
						</div>
						<?php qode_excerpt(); ?>
						<span class="single_social_share_mobile"><?php echo do_shortcode('[social_share_list]'); ?></span>
						<a class="IHM_read_more" href="<?php the_permalink(); ?>">Read More</a>
					</div>
				</div>
			</div>
		</article>
